...
import com.schoolease.dao.UserDao;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> getUserByRoleAndBatchAndStatus(String role, Batch batch, String status) {
		// TODO Auto-generated method stub
		return this.userDao.findByRoleAndBatchAndStatus(role, batch, status);
	}

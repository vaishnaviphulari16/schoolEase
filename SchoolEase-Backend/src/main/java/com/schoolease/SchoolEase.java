...
public class SchoolEase implements CommandLineRunner {

	private final Logger LOG = LoggerFactory.getLogger(SchoolEase.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(SchoolEase.class, args);
	}
